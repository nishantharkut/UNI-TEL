...
const EXAM_TYPES = ['Mid Term', 'End Term', 'Quiz', 'Assignment', 'Lab Exam', 'Viva', 'Project', 'Other'];
            ...
            <div className="p-3 bg-muted rounded-lg">
              <div className="flex items-center justify-between mb-2">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm">Score: {formData.obtained_marks}/{formData.total_marks}</span>
                </div>
