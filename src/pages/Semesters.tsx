...
export default function Semesters() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-muted/10 overflow-x-hidden w-full max-w-full">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-6 lg:py-8 max-w-5xl w-full max-w-full overflow-x-hidden">
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center gap-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xl sm:text-2xl lg:text-3xl font-bold text-white">{academicSummary.cgpa.toFixed(2)}</p>
                      </div>
                    </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6 mt-6">
                <div className="space-y-3">
                  ...
                  <Input
                    ...
                    required
                    className={cn(
                      "h-14 sm:h-12 text-base rounded-xl border-2 focus:border-academic-primary transition-colors touch-target",
